    ...
    <div className='side'>
      ...
      <div className='dumm'>
        ...
        <div class="mytabs">
          ...
          <label class="label" for="tabAzure">Azure Fundamentals</label>
          <div class="tab">
            <h1>Azure <br />Fundamentals</h1>
            <p class="p-task">
          ...
          <label class="label" for="tabData">Data Fundamentals</label>
          <div class="tab">
            <h1>Data <br />Fundamentals</h1>
            <p class="p-task">
              ...
              relational, non-relational, big data, and analytics.<br /><br />
            </p>
            <button class="tsk-btn">
              <a
          ...
          <label class="label" for="tabSecurity">Security Fundamentals</label>
          <div class="tab">
            <h1>Security <br />Fundamentals</h1>
            <p class="p-task">
